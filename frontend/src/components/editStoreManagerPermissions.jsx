...
class EditStoreManagerPermissions extends Component {
  state = {
    error: undefined,
    canAddProduct: this.props.management.permissions?.canAddProduct,
    canDeleteProduct: this.props.management.permissions?.canDeleteProduct,
    canUpdateProduct: this.props.management?.permissions?.canUpdateProduct,
    canGetSellersInfo: this.props.management?.permissions?.canGetSellersInfo,
  };
...
export default connect(mapStateToProps)(EditStoreManagerPermissions);
