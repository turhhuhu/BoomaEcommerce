...
{
    public class PaymentSystemsAcceptanceTests : IAsyncLifetime
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            var purchasesServicePaymentFail = serviceMockFactory.MockPurchaseServiceWithCollapsingExternalSystem();
